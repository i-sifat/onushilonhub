...
const modifierRules: GrammarRule[] = [
    {
    id: 1,
    ruleNo: "Rule 1",
...
export default function ModifierGrammarRules() {
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        {modifierRules.map((rule) => (
          ...
          >
            ...
            {/* Structure */}
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-sf-text-bold mb-3">Structure:</h3>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-3">
                {rule.examples.map((example, index) => (
                  ...
                  >
                    <p className="text-sf-text-subtle leading-relaxed font-medium">
                      {example}
                    </p>
                  </div>
                ))}
      ...
      <div className="mt-12 text-center bg-sf-highlight/10 rounded-xl p-8 border border-sf-button/20">
        ...
        <p className="text-sf-text-subtle mb-6">
          ...
          to master modifier techniques.
        </p>
        <Link
          href="/board-questions/hsc/modifier"
