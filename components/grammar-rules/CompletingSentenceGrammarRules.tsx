...
const completingSentenceRules: GrammarRule[] = [
 {
    id: 1,
...
export default function CompletingSentenceGrammarRules() {
  return (
    <div className="space-y-8">
      ...
      <div className="mt-12 text-center bg-sf-highlight/10 rounded-xl p-8 border border-sf-button/20">
        ...
        <p className="text-sf-text-subtle mb-6">
          ...
          to master completing sentence techniques.
        </p>
        <Link
          href="/board-questions/hsc/completing-sentence"
