...
export default function NarrationQuestionsPage() {
  ...
  const filteredQuestions = useMemo(() => {
    return narrationQuestions.filter(question => {
  ...
  }, [searchTerm, selectedBoard, selectedYear, selectedType]);
  ...
  const hasActiveFilters = searchTerm || selectedBoard !== 'All Boards' || selectedYear !== 'All Years' || selectedType !== 'All Types';
            ...
            return (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-md font-semibold text-sf-text-bold mb-2">Question:</h4>
                    ...
                    <div className="flex items-center justify-center pt-2">
                      <ArrowRightLeft className="h-4 w-4 text-sf-button" />
                    </div>
                  </div>
                </CardContent>
              </Card>
