...
export default function SSCCompletingSentenceGrammarLoading() {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="h-10 bg-sf-text/10 rounded-md w-96 mx-auto animate-pulse" />
          <div className="h-5 bg-sf-text/10 rounded-md w-80 mx-auto animate-pulse" />
        </div>

        {/* Grammar rules list skeleton */}
        <div className="space-y-6">
          <div className="flex items-center justify-center">
            <LoadingSpinner size="md" text="Loading SSC completing sentence grammar rules..." />
          </div>
          <ListSkeleton 
            count={4} 
