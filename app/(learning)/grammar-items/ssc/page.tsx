...
export default function SSCGrammarItemsPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-sf-text-bold mb-6">
            SSC <span className="text-sf-button">Grammar Items</span>
          </h1>
          <p className="text-xl text-sf-text-subtle max-w-3xl mx-auto">
            SSC grammar items are coming soon. We're working hard to bring you 
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-sf-bg border border-sf-text-muted/20 rounded-xl p-8 text-center">
            <h2 className="text-2xl font-bold text-sf-text-bold mb-4">
              SSC Grammar Items - Coming Soon
            </h2>
            
            <p className="text-sf-text-subtle mb-6 leading-relaxed">
              We're currently developing comprehensive SSC grammar items. All SSC features are temporarily disabled while we focus on perfecting the HSC experience.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/grammar-items/hsc"
