...
export default function GetStartedSynonymAntonymLoading() {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="h-5 bg-sf-text/10 rounded-md w-88 mx-auto animate-pulse" />
        </div>

        {/* Content skeleton */}
        <div className="space-y-6">
          <div className="flex items-center justify-center">
            <LoadingSpinner size="md" text="Loading synonym & antonym resources..." />
          </div>
