...
import RightFormVerbGrammarRules from '@/components/grammar-rules/RightFormVerbGrammarRules';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-sf-text-bold mb-6">
            HSC <span className="text-sf-button">Use of Verbs</span> Rules
          </h1>
          <p className="text-xl text-sf-text-subtle max-w-3xl mx-auto">
            Master the right form of verbs with comprehensive grammar rules, structures, and examples. 
            Learn the patterns and techniques used in HSC board examinations.
          </p>
        </div>

        {/* Grammar Rules Component */}
        <RightFormVerbGrammarRules />
      </div>
    </div>
  );
}