...
import NarrationGrammarRules from '@/components/grammar-rules/NarrationGrammarRules';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-sf-text-bold mb-6">
            HSC <span className="text-sf-button">Narration</span> Rules
          </h1>
          <p className="text-xl text-sf-text-subtle max-w-3xl mx-auto">
            Master the art of converting direct speech to indirect speech and vice versa. 
            Learn the patterns and techniques used in HSC board examinations.
          </p>
        </div>

        {/* Grammar Rules Component */}
        <NarrationGrammarRules />
      </div>
    </div>
  );
}